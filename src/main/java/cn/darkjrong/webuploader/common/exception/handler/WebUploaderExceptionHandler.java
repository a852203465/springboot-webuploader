package cn.darkjrong.webuploader.common.exception.handler;
...
public class WebUploaderExceptionHandler {
     ...
     * @date 2019/4/3 8:46
     */
    @ExceptionHandler(value = WebUploaderException.class)
    public ResponseVO serviceExceptionHandler(WebUploaderException e){
    ...
    public ResponseVO defaultErrorHandler( Exception e) {
        ...
        if (e.getCause() instanceof WebUploaderException) {
            serviceExceptionHandler((WebUploaderException)e);
        }

...
public class RedisUtils {
    ...
    public List<String> leftPopGet(String key) {
        ...
        for(int i = 0;i < size ;i++){
            ...
            Optional.ofNullable(object).ifPresent(a -> result.add(a.toString()));
        }
        return result;
    }

    public void rightPushSet(String key,String value) {
    ...
    public <T> List<T> lGet(String key, Class<T> clazz) {
        ...
        if (object instanceof List) {
            List objectList = JSONObject.parseObject(JSON.toJSONString(object), List.class);
            for (Object obj : objectList) {
                T t = fromJson(obj, clazz);
                tList.add(t);
            }
        }
